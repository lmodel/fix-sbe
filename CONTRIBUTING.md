# Contributing to fix-sbe

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
fix-sbe. These guidelines are not strict rules.
...
The fix-sbe team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the fix-sbe technical leads
...
[issues]: https://github.com/lmodel/fix-sbe/issues/
[pulls]: https://github.com/lmodel/fix-sbe/pulls/
